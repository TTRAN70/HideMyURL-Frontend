...
const Saved = () => {
  ...
  return (
    <div className="sbody">
      <Navbar />
      <div className="linkbody rounded-3 pt-2 size container-sm shadow-lg">
        {linkList.map((item, key) => {
          return (
            <div
              className="linklist position-relative lh-lg links p-2 ps-3 ml-3 rounded-3 mt-3 mb-3 container-sm"
              key={key}
            >
              <button
              ...
              <a
                target="_blank"
                rel="noreferrer"
                href={item[0].originalURL}
                className="text-secondary d-block slink"
              >
                {item[0].originalURL}
              </a>
              {item[0].password ? (
              ...
              <div className="created">{item[0].createdAt}</div>
            </div>
          );
        })}
      </div>
